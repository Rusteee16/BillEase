...
public class SetupPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bisname;
        bisname = PreferenceManager.getDefaultSharedPreferences(this)
                .getString(SetupPasswordActivity.SETUP_BUSINESS_NAME_KEY, null);
        if(bisname != null)
        {
            startActivity(new Intent(getApplicationContext(),NewBillCustomerActivity.class));
        }
        ...
        setupPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(newPassword.equals(confirmPassword)){
                    ...
                    startActivity(new Intent(SetupPasswordActivity.this, NewBillCustomerActivity.class));
